      ...
      <div className="max-w-6xl mx-auto space-y-24">
        ...
        <section className="flex flex-col-reverse lg:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Where ideas meet influence. <strong>D-Mic</strong> is your
              professional mic — a hybrid of Twitter and LinkedIn for
              educational conversations. Share your thoughts. Build your voice.
              Expand your impact.
            </p>
        ...
        <section className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-md text-gray-700 leading-relaxed">
              <strong>D-Mic</strong> is the ultimate convergence of
              microblogging and professional networking. Post like you tweet,
              engage like you’re on LinkedIn — except it’s faster, more open,
              and driven by educators, learners, and leaders.
            </p>
            <ul className="list-disc pl-6 mt-4 text-gray-600">
              <li>
                Post short, insightful thoughts on education and industry trends
              </li>
              <li>
                Grow your influence and followers through professional content
              </li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Share insights that spark ideas and inform your network —
                  D-Mic posts are short but sharp, tailored for impact.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Build authentic relationships with educators, leaders, and
                  change-makers in your field — without the noise.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Whether you’re a student or a senior executive, D-Mic gives
                  your voice the reach it deserves in professional circles.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Foster intelligent discussion on industry trends, innovation,
                  and education — in a space built for thoughtful engagement.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="text-center">
          <h2 className="text-3xl font-bold text-blue-800 mb-4">
            Be Heard. Be Professional. Be You.
          </h2>
          <p className="text-lg text-gray-600 mb-6">
            Join thousands of thinkers, learners and leaders on D-Mic today.
          </p>
          <button className="px-6 py-3 bg-blue-600 text-white rounded-full shadow hover:bg-blue-700 transition">
            Claim Your Voice
          </button>
